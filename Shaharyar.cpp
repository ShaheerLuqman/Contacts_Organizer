...
void createContact()
{
    ...
    {
        ofstream phone("contactsFile.csv", ios::app); // file name
        system("cls");
        cout << endl
             << "Enter the name: " << endl;
        cin >> a.name;
        ...
        if (check_digits(a.numbers[count]) == true)
        {
            if (check_numbers(a.numbers[count]) == true)
            {
                if (phone.is_open())
                {
                    phone << a.name << " " << a.numbers[count] << endl;
        ...
        internationalization(&a.numbers[count]);
        cout << endl
             << endl;
        system("pause");
        system("cls");
...
void invalidContact(contact &cont)
{
